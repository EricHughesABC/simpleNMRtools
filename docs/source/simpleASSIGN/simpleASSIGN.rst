...
produced by the simplePREDICT tool into MNOVA. From there the user can
...
.. figure:: ./media/image3.png
   ...
   Figure 3 COSY spectrum showing correlation between the protons on
   carbon 8 and 10 in the molecule by hovering over the peak label in
   the COSY spectrum at (0.82,1.82) ppm.
